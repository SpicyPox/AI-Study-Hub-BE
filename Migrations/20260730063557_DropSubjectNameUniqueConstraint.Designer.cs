...
namespace AIStudyHub.Api.Migrations
{
    ...
    [Migration("20260730063557_DropSubjectNameUniqueConstraint")]
    partial class DropSubjectNameUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIStudyHub.Api.Models.DocumentComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("document_comments_pkey");

                    b.HasIndex("UserId");

                    b.HasIndex(new[] { "DocumentId" }, "idx_document_comments_document_id");

                    b.ToTable("document_comments", "ai_study_hub");
                });

            modelBuilder.Entity("AIStudyHub.Api.Models.DocumentRating", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "DocumentId")
                        .HasName("document_ratings_pkey");

                    b.HasIndex(new[] { "DocumentId" }, "idx_document_ratings_document_id");

                    b.ToTable("document_ratings", "ai_study_hub");
                });
            ...
            modelBuilder.Entity("AIStudyHub.Api.Models.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "DocumentId" }, "idx_quizzes_document_id");

                    b.HasIndex(new[] { "UserId" }, "idx_quizzes_user_id");

                    b.ToTable("quizzes", "ai_study_hub");
                });

            modelBuilder.Entity("AIStudyHub.Api.Models.QuizAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "QuizId" }, "idx_quiz_attempts_quiz_id");

                    b.HasIndex(new[] { "UserId" }, "idx_quiz_attempts_user_id");

                    b.ToTable("quiz_attempts", "ai_study_hub");
                });

            modelBuilder.Entity("AIStudyHub.Api.Models.QuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "QuizId" }, "idx_quiz_questions_quiz_id");

                    b.ToTable("quiz_questions", "ai_study_hub");
                });
            ...
            modelBuilder.Entity("AIStudyHub.Api.Models.QuizAttempt", b =>
                {
                    b.HasOne("AIStudyHub.Api.Models.Quiz", "Quiz")
                        .WithMany("Attempts")
